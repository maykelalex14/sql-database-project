SELECT d.destination_location, COUNT(b.booking_id) AS booking_count
FROM destinations d
JOIN bookings b ON d.destination_id = d.destination_id
GROUP BY d.destination_location; --works

SELECT SUM(total_price) AS total_revenue
FROM bookings; -- shows the total price of the revenue

SELECT d.destination_location, COUNT(b.booking_id) AS bookings_count
FROM bookings b
JOIN flights f ON b.flight_id = f.flight_id
JOIN destinations d ON f.destination_id = d.destination_id
GROUP BY d.destination_location
...
INNER JOIN accomodations a ON b.accomodation_id = a.accomodation_id; -- works (shows bookingid, airline, accomodationname, and total price)

SELECT c.customer_id, c.customer_name, c.customer_gender, b.booking_id
FROM customers c
LEFT JOIN bookings b ON c.customer_id = b.customer_id; -- works (shows, customerid, name, gender and booking id)

SELECT f.flight_id, f.airline, b.booking_id
FROM flights f
RIGHT JOIN bookings b ON f.flight_id = b.flight_id; --works (shows flightid, airline and booking id)

SELECT a.accomodation_name, b.booking_id
FROM accomodations a
FULL OUTER JOIN bookings b ON a.accomodation_id = b.accomodation_id; --wprks (shows accomodationname is bookingid)
